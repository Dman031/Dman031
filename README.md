...
**Enterprise Consultant** | ServiceNow | Oracle | Cloud Infrastructure | AI Solutions

---

## 🚀 Live Portfolio Projects

### [ServiceNow SLG Demo](https://kcm4sbxykwsmtm6v94heng.streamlit.app)
...
| Platforms | Oracle, ServiceNow, OCI |
|-----------|------------------------|
| Technical | Python, Terraform, SQL, PL/SQL |
| Compliance | HIPAA, SOX, PCI-DSS |
| AI | Now Assist, Workflow Automation |
